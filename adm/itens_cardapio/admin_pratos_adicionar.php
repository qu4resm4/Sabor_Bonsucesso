...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO cardapio (nome, descricao, preco, status) VALUES ('$nome', '$descricao', '$preco', '$status')";
    if (mysqli_query($conexao, $sql) === TRUE) {
        $prato_id =  mysqli_insert_id($conexao); // ID do prato recém-criado
        ...
        if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] == 0) {
            ...
            if (move_uploaded_file($imagemTmp, $imagemPasta)) {
                ...
                $sqlImagem = "UPDATE cardapio SET imagem = '$imagemNome' WHERE id = '$prato_id'";
                if (mysqli_query($conexao, $sqlImagem) === TRUE) {
                    header('Location: admin_pratos.php');
                } else {
                    echo "Erro ao salvar a imagem: " . mysqli_error($conexao);
                }
            } else {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav justify-content-center flex-grow-1 ">
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 fw-bold" href="admin_pratos_adicionar.php">Home</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="row">
                      ...
                      <div class="fundo_bloco">
                        <div class="row p-3">
                          ...
                          <a href="/restaurante/adm/admin_pratos.php" class="lista_admin_fale_conosco_voltar">Voltar</a>
                          </div>
...
<div class="text-center p-1" style="background-color: rgba(0, 0, 0, 0.2)">
    ©2024 Copyright
    <a class="text-white text-decoration-none" href="/restaurante/portfolio.php">ADS</a>
</div>
</footer>
